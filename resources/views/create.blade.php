    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Create new invoice</h1>
    ...
    $(document).ready(function () {
        ...
        $("#add").on('click', function () {
            ...
            var table = '<tr class="invoice-item">';
                table += '<td>'+i+'</td>';
                table +='<td><input type="text" name="product_name[]" value="'+product_name+'" class="form-control product_name"></td>';
                table +='<td><input type="text" name="price[]" value="'+price+'" class="form-control price"></td>';
                table +='<td><input type="text" name="qty[]" value="'+qty+'" class="form-control qty"></td>';
                table +='<td class="total">'+total.toFixed(2)+'</td>';
                table +='<td><div class=\"btn btn-danger del  \">Delete</div></td>';
                table += '<input type="hidden" name="product_name[]" value="'+i+'" class="product_id">';
                table +='</tr>';
            $("tbody").append(table);
        ...
        $('#table').on('click', '.del',function () {
            var total = $(this).closest('.invoice-item').find('.total').text();
            var grand_total = $('#grand-total').text() - total;
        ...
        $(document).on('change','.price, .qty', function () {
            ...
            invoice_item.find('.total').text(product_total.toFixed(2));
            grandTotal();
        }).trigger('change');
        ...
        function grandTotal() {
            ...
            return $('#grand-total').text(grand_total);
        }
